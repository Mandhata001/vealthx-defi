    ...
    <div className="space-y-20">
      ...
      <div className="text-center py-20">
        <div className="space-y-8 max-w-5xl mx-auto">
          ...
          <p className="text-2xl lg:text-3xl text-gray-300 mb-8 font-light leading-relaxed">
            Deposit assets, earn yield, and borrow instantly — powered by smart routing
          </p>
          
          {/* Secondary Description */}
          <p className="text-xl text-purple-200 mb-12 max-w-3xl mx-auto leading-relaxed">
            Access instant RWA liquidity, advanced yield strategies, and seamless DeFi operations 
            on the fastest blockchain. Built for institutions and power users.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-gray-300">Access real-world asset liquidity pools with zero slippage routing</p>
        </div>
        
        <div className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
          <div className="text-4xl mb-4">📈</div>
          <h3 className="text-xl font-bold text-white mb-3">Advanced Yield</h3>
          <p className="text-gray-300">Automated strategies maximizing returns across multiple protocols</p>
        </div>
        
        <div className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
          <div className="text-4xl mb-4">🔒</div>
          <h3 className="text-xl font-bold text-white mb-3">Secure Vaults</h3>
          <p className="text-gray-300">Institutional-grade security with smart contract audits</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-white text-center mb-16">How VealthX Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300">Connect your wallet and deposit assets into our yield-optimized vaults</p>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300">Our algorithms automatically route your funds to highest-yield opportunities</p>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300">Earn passive income and borrow against your positions with competitive rates</p>
          </div>
        </div>
      </div>
    </div>
