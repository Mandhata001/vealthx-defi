    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="h-64 w-full">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={MOCK_YIELD_DATA} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
      ...
      <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <p className="text-sm font-medium text-green-800">Performance Trending Up</p>
            <p className="text-xs text-green-600">Yield has increased 18% over the past week</p>
          </div>
        </div>
      </div>
    </div>
